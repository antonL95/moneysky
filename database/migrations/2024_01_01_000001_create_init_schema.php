...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('newsletter_subscribers', static function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('user_bank_sessions', static function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id');
        ...
        Schema::create('user_bank_transactions_raw', static function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('transaction_tags', static function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('user_transaction_tags', static function (Blueprint $blueprint) {
            $blueprint->id();
        ...
        Schema::create('user_transactions', static function (Blueprint $blueprint) {
            $blueprint->id();
            $blueprint->unsignedBigInteger('user_id');
