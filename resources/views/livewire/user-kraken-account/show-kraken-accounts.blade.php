<div>
    <div class="flex justify-end">
        <x-mary-button link="{{route('app.add-kraken-accounts')}}" wire:navigate>
    ...
    <x-mary-table :headers="$headers" :rows="$rows" with-pagination class="" :sort-by="$sortBy" >
        ...
        <div class="flex items-center justify-end">
            <x-mary-button icon="fas.pencil" href="{{route('app.update-kraken-accounts', ['account' => $row->id])}}" wire:navigate class="btn-sm bg-yellow-300" />
