            ...
            <div class="px-4 mx-auto max-w-screen-2xl lg:px-12">
                <div class="relative overflow-hidden bg-primary-50 shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <div
                        ...
                        <div
                            ...
                            @if(auth()->user()->subscribed())
                                <x-button-link
                                    href="{{route('app.add-stock-market')}}"
                                    class="inline-flex"
                                    type="button">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach($tickers as $ticker)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-primary-50">
                                        <div class="flex items-center">
                                            <x-amount-format :amount="$ticker->price_cents"
                                                             :amount-currency="'USD'"/>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{$ticker->id}}-dropdown-button"
                                                data-dropdown-toggle="{{$ticker->id}}-dropdown"
                                        ...
                                        <div id="{{$ticker->id}}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{$ticker->id}}-dropdown-button">
                                                <li>
                                                    <a href="{{route('app.update-stock-market', ['ticker' => $ticker->id])}}"
                                                       wire:navigate
                        ...
                        {{ $tickers->links('components.table-pagination') }}
                    </div>
                </div>
            </div>
        </section>
