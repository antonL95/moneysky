...
assetName: string;
color: string;
assetsData: { [key: number]: App.Data.App.Dashboard.HistoricalAssetData } | Array<any>;
};
export type TagData = {
id: number;
name: string;
...
export type BalanceType = 'closingAvailable' | 'closingBooked' | 'expected' | 'forwardAvailable' | 'interimAvailable' | 'information' | 'interimBooked' | 'nonInvoiced' | 'openingBooked' | 'openingAvailable' | 'previouslyClosedBooked';
