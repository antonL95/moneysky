...
## Limitations
In no event shall MoneySky or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use moneysky.app.

## Accuracy of Materials
The materials appearing in moneysky.app could include technical, typographical, or photographic errors. MoneySky does not warrant that any of the materials on its app are accurate, complete, or current.

## Links
MoneySky has not reviewed all of the sites linked to its app and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by MoneySky of the site. Use of any such linked website is at the user's own risk.

## Modifications
MoneySky may revise these terms of use for its app at any time without notice. By using this app, you are agreeing to be bound by the then-current version of these terms of use.
